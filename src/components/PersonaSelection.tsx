      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="flex items-center justify-center mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-mindful-400 to-enso-500 rounded-xl flex items-center justify-center zen-shadow">
              ...
              {recommendedTherapists.map((therapist) => {
                ...
                return (
                  <CarouselItem key={therapist.id} className="pl-2 md:pl-4 basis-[85%] sm:basis-[80%]">
                    <Card
                      className={`cursor-pointer transition-all duration-300 border-2 bg-gradient-to-br from-mindful-50 to-enso-50 backdrop-blur-sm h-full relative ${
                        isSelected
                          ? 'border-mindful-400 bg-gradient-to-r from-mindful-100 to-enso-100 zen-shadow ring-4 ring-mindful-200'
                          : 'border-mindful-200 zen-shadow hover:border-mindful-300'
                      }`}
                      ...
                      <CardContent className="p-6 relative h-full flex flex-col">
                        ...
                        {isSelected && (
                          <div className="absolute top-4 right-4 z-10">
                            <CheckCircle className="w-5 h-5 text-mindful-600 fill-current" />
                          </div>
                        )}

                        {/* Avatar */}
                        <div className="flex justify-center mb-6">
                          <Avatar className="w-32 h-32 zen-shadow ring-4 ring-mindful-300">
                            <AvatarImage 
                              src={therapist.image_url || ''} 
                              alt={`${therapist.name} avatar`}
                              className="object-cover"
                            />
                            <AvatarFallback className="bg-gradient-to-br from-mindful-400 to-enso-500 text-white text-3xl">
                        ...
                        <div className="text-center mb-6">
                          ...
                          <div className="text-sm text-mindful-600 font-semibold">
                            Compatibility: {recommendation?.score}/4 ⭐
                          </div>
                        </div>

                        {/* Style */}
                        <div className="rounded-lg p-4 border flex-grow bg-gradient-to-r from-mindful-50 to-enso-50 border-mindful-200">
                          <h4 className="font-semibold text-neutral-800 mb-2 text-sm">Therapy Style:</h4>
            ...
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                selectedTherapist === therapist.id
                  ? 'bg-mindful-400 w-6'
                  : 'bg-mindful-300 hover:bg-mindful-400'
              }`}
            />
          ))}
        </div>
        ...
        <div className="text-center mb-6">
          <Button
            ...
            className={`w-full mobile-button text-base font-medium transition-all duration-300 ${
              selectedTherapist
                ? 'bg-gradient-to-r from-mindful-400 to-enso-500 hover:from-mindful-500 hover:to-enso-600 text-white hover:scale-105 zen-shadow'
