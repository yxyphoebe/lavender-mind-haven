    ...
    <div className="min-h-screen bg-gradient-to-br from-lavender-50 via-white to-rose-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md animate-slide-up">
        ...
        <Card className="glass-effect border-0 mindful-shadow">
          <CardHeader>
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 bg-lavender-50 rounded-xl">
                <TabsTrigger value="login" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-lavender-700">
                  Sign In
                </TabsTrigger>
                <TabsTrigger value="signup" className="rounded-lg data-[state=active]:bg-white data-[state=active]:text-lavender-700">
                  Sign Up
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="login" className="mt-6">
                ...
                <CardContent className="space-y-4 p-0">
                  ...
                  <Button 
                    ...
                    className="w-full h-12 bg-gradient-to-r from-lavender-500 to-lavender-600 hover:from-lavender-600 hover:to-lavender-700 text-white rounded-xl font-medium transition-all duration-300"
                    disabled={isLoading}
                  >
        ...
        <p className="text-center text-sm text-sage-500 mt-6 leading-relaxed">
          ...
          <a href="#" className="text-lavender-600 hover:underline">Terms of Service</a>
          {' '}and{' '}
          <a href="#" className="text-lavender-600 hover:underline">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
