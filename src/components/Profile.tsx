    ...
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-blue-50">
      <div className="container mx-auto px-4 py-6 max-w-md">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="font-display text-2xl font-light text-slate-700">
            Profile
          </h1>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col text-center">
              {isEditing ? (
                <div className="w-full space-y-3">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1 border-slate-200 bg-white/80"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <h2 className="font-display text-2xl font-light text-slate-800 mb-3">
                    {userInfo.name}
                  </h2>
        ...
        <Card className="mb-6 glass-effect border-0 zen-shadow">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between py-2">
              ...
              <Button variant="outline" size="sm" className="border-slate-300 hover:bg-slate-100 bg-white/80">Configure</Button>
            </div>
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Button variant="outline" size="sm" className="border-slate-300 hover:bg-slate-100 bg-white/80">Manage</Button>
            </div>
            ...
            <div className="flex items-center justify-between py-2">
              ...
              <Button variant="outline" size="sm" className="border-slate-300 hover:bg-slate-100 bg-white/80">Edit</Button>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-6 glass-effect border-0 zen-shadow">
          <CardContent className="p-4">
            <Button
              ...
              className="w-full text-red-600 border-red-300 hover:bg-red-50 bg-white/80"
            >
